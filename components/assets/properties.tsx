...
const Properties = () => {
  return (
    <>
      <div className='w-screen bg-[url("/img/property.jpg")] aspect-[5/1] bg-no-repeat bg-bottom bg-cover relative lg:lg:-left-8'>
      ...
      <div className="flex flex-col lg:flex-row gap-6 border border-white rounded-tl-[1.875rem] rounded-br-[1.875rem] overflow-hidden mt-4 mx-6 lg:mx-0">
        ...
        <div className="w-full flex justify-center items-center px-4 py-4 lg:py-4 lg:px-0">
          <p className="text-base lg:text-xl leading-[150%]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-4 justify-center px-6 lg:px-0">
