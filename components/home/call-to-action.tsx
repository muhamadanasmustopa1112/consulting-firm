    ...
    <section className="pl-56 pr-24 py-24 flex flex-row items-center gap-24 relative z-0">
      ...
      <div className="min-w-0 w-2/5 flex flex-col gap-6">
          ...
          <div className="inline-flex">
            <input
              ...
              className={
                ...
                ' px-6 py-2 placeholder:text-[#D9D9D9] placeholder:font-["inherit"]'
              }
            />
            <button
              type="button"
        ...
        <Link
          ...
          className={
            sourceSansPro.className +
            " border border-white rounded-tl-[1.875rem] rounded-br-[1.875rem] p-4 inline-flex justify-between items-center self-start gap-4 transition-colors hover:bg-grey"
          }
        >
