  ...
  return (
    <>
      <form
        id="contact-form"
        action={formAction}
        className="flex flex-col gap-4 w-12/12"
      >
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className={`${props.sourceSansPro.className} p-2 placeholder:text-[#D9D9D9] placeholder:font-[${props.sourceSansPro.className}] text-black text-sm`}
            required
          />
        </div>
        <div className="flex flex-col gap-2">
      ...
      <p
        ...
        aria-live="polite"
        className={
          "px-4 py-2 rounded-tl-3xl rounded-br-3xl border border-white transition-opacity opacity-0 " +
          (status == null
            ? ""
            : status
