...
const page = () => {
  return (
    <div className="py-16 px-4 md:py-32 md:px-12 lg:py-48 lg:px-32 relative z-10">
      <div className="flex flex-col md:flex-row justify-stretch gap-8">
        <div className="md:w-3/5">
          ...
          <p className="leading-relaxed mb-4 text-sm md:text-base">
            ...
            initiatives we have in the pipeline. If you&apos;re eager to delve
            deeper into our work, request a whitepaper, lightpaper, or technical
            ...
            Agreement. Let&apos;s embark on innovation together-simply fill out
            the form below to express your interest and unlock the future with
            us.
          </p>
          <button
            type="button"
