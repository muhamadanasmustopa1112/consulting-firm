...
export default function Page() {
  return (
    <div className="py-4 sm:py-6 md:py-8 px-4 sm:px-8 lg:px-12 xl:px-48 2xl:px-56 relative z-10 bg-black/70 text-white">
      <div className="flex flex-col lg:flex-row justify-stretch gap-8">
        ...
        <div className="w-full h-0.5 lg:w-0.5 lg:h-auto bg-white flex-shrink-0 my-4 lg:my-0"></div>
        <div className="w-full flex flex-col gap-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-2 sm:mb-4">
